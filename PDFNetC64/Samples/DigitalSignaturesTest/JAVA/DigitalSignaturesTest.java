...
public class DigitalSignaturesTest {
    ...
    public static boolean signPDF() {
        ...
        String infile = input_path + "doc_to_sign.pdf";
        String outfile = output_path + "signed_doc.pdf";
        String certfile = input_path + "pdftron.pfx";
        String imagefile = input_path + "signature.jpg";

        System.out.println("Signing PDF document \"" + infile + "\".");
    ...
    public static boolean certifyPDF() {
        ...
        String infile = input_path + "newsletter.pdf";
        String outfile = output_path + "newsletter_certified.pdf";
        String certfile = input_path + "pdftron.pfx";

        System.out.println("Certifying PDF document \"" + infile + "\".");
        try {
            // Open an existing PDF
            PDFDoc doc = new PDFDoc(infile);
            ...
            System.out.println("Finished certifying PDF document.");
        } catch (Exception e) {
            System.err.println(e.getMessage());
            e.printStackTrace(System.err);
            result = false;
